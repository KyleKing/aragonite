// Package display renders forge and vcs models as plain text. Anything that
// emits a glyph, a placeholder, or a human-readable duration belongs here
// rather than in the data packages it reads, which is what keeps forge and
// vcs from importing each other.
package display
