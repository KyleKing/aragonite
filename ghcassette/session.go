...
// CI does.
const RecordEnv = "GHCASSETTE_RECORD"

const stubPackage = "github.com/kyleking/aragonite/ghcassette/ghstub"
...
// GHCASSETTE_RECORD=1 re-records the cassette against the real gh,
