...
func (j *JJOperations) branchList(ctx context.Context, repoPath string) ([]BranchInfo, error) {
	out, err := j.runJJ(ctx, repoPath, "bookmark", "list", "--all-remotes", "-T", jjBookmarkListFormat)
	if err != nil {
		return nil, err
	}
...
func (j *JJOperations) commitLog(ctx context.Context, repoPath string, count int) ([]CommitInfo, error) {
