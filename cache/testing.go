...
// Test seams. A consumer of this package needs the same control its own tests
// have: a clock it can advance, a byte budget it can overflow, and a store it can
