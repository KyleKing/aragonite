...
func (g *GitOperations) GetRepoSummary(ctx context.Context, repoPath string) (RepoSummary, error) {
	...
	summary.RemoteID = RemoteIdentity(remoteURL)
...
func (g *GitOperations) GetCurrentBranch(ctx context.Context, repoPath string) (string, error) {
	...
	if out == "HEAD" {
		...
		return DetachedBranchLabel(hash), nil
	}
...
func (g *GitOperations) GetBranchList(ctx context.Context, repoPath string) ([]BranchInfo, error) {
	return cachedBranchList(repoPath, func() ([]BranchInfo, error) {
		return g.branchList(ctx, repoPath)
	})
}

func (g *GitOperations) branchList(ctx context.Context, repoPath string) ([]BranchInfo, error) {
...
func (g *GitOperations) GetStashList(ctx context.Context, repoPath string) ([]StashDetail, error) {
	...
	for scanner.Scan() {
		...
		stashes = append(stashes, StashDetail{
			Index:   index,
			Message: parts[1],
			Date:    time.Unix(ts, 0),
		})
...
func (g *GitOperations) GetCommitLog(ctx context.Context, repoPath string, count int) ([]CommitInfo, error) {
	return cachedCommitLog(repoPath, count, func() ([]CommitInfo, error) {
		return g.commitLog(ctx, repoPath, count)
	})
}

func (g *GitOperations) commitLog(ctx context.Context, repoPath string, count int) ([]CommitInfo, error) {
	format := "%H\t%h\t%s\t%an\t%ct"
...
func (g *GitOperations) getConfigOverrides(ctx context.Context, repoPath string) []GitConfigOverride {
